 ...
 * @author ADMIN
 */
public class FilterAllAccountRequest implements Filter {
    ...
    public FilterAllAccountRequest() {
    }    
    
    private void doBeforeProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FilterAllAccountRequest:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(ServletRequest request, ServletResponse response)
            throws IOException, ServletException {
        if (debug) {
            log("FilterAllAccountRequest:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("FilterAllAccountRequest:doFilter()");
        }
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("FilterAllAccountRequest:Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("FilterAllAccountRequest()");
        }
        StringBuffer sb = new StringBuffer("FilterAllAccountRequest(");
